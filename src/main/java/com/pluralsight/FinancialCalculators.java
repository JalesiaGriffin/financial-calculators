...
public class FinancialCalculators {
    ...
    public static void mortgageCalculator(Scanner scan) {
        ...
        double onePlusInterestRaised = Math.pow(onePlusInterest, loanLength);
        double monthlyPayment = (principal * interestRate * onePlusInterestRaised / onePlusInterestRaised - 1);
